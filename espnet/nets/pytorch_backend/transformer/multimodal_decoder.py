...
class MultimodalDecoder(ScorerInterface, torch.nn.Module):
    ...
    def forward(self, tgt, tgt_mask, memory, memory_mask, vbs):
        """Forward decoder.
    ...
    def forward_one_step(self, tgt, tgt_mask, memory, vbs=None, cache=None):
        """Forward one step.
